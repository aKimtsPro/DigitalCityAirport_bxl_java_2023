...
//    }
    ...
    @GetMapping(path= "/passenger",params = {"fidelity", "page"})
    public ResponseEntity<Page<PassengerDTO>> findPassengerByFidelity(@RequestParam FidelityStatus fidelity, @RequestParam int page){
        return ResponseEntity.ok(
                personService.getPassengerByFidelity(fidelity, page)
